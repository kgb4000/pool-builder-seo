...
export default function PhoenixAZ() {
  ...
  return (
    <>
      <NextSeo {...SEO} />
      <Nav
        homeLink="/swimming-pool-company-seo-phoenix-az"
        homeText="Home"
        serviceLink="#phoenixservices"
        serviceText="SEO Services"
        whyMeLink="#why-me-phoenix"
        whyMeText="Why Me"
        faqLink="#phoenixFaq"
        faqtext="FAQ"
        blogLink="/blog"
      ...
      <div className="hero">
        <div className="container">
          <h1 className="title">
            Swimming Pool Company SEO for Pool Companies in Phoenix, AZ
          </h1>
          <div className="subtext">
            <p>
              I help pool builders and pool service companies in Phoenix, AZ get
        ...
        <div className="container">
          ...
          <Reason>
            ...
            <div className="grid-item-1">
              ...
              <p>
                ...
                just be known as another player in the Phoenix pool industry.
          ...
          <Reason>
            ...
            <div className="grid-item-2">
              ...
              <p>
                Imagine this scenario: A homeowner in Phoenix, lounging in their
                ...
                companies in Phoenix" or "nearby pool maintenance".
              </p>
              <p>
            ...
            <Service>
              ...
              <div>
                ...
                <p>
                  ...
                  finely tuned to the unique intricacies of the Phoenix pool
                  industry.
                </p>
                <p>
                ...
                <p>
                  ...
                  digital footprint, setting you apart in Phoenix's competitive
                  pool market.
                </p>
              </div>
            </Service>
            <Service>
              ...
              <div>
                ...
                <p>
                  ...
                  impactful – in the heart of the Phoenix community.
                </p>
                <p>
                ...
                <p>
                  ...
                  Phoenix pool enthusiasts, building a palpable community bond.
                </p>
                <p>
                ...
                <p>
                  ...
                  Phoenix's premier pool authority. Dive deep into the local
            ...
            <Service>
              ...
              <div>
                ...
                <p>
                  ...
                  tailored for your Phoenix pool business.
                </p>
                <p>
            ...
            <Service>
              ...
              <div>
                ...
                <p>
                  ...
                  zenith of online potential for your Phoenix pool enterprise.
                </p>
              </div>
            </Service>
          </Services>
          <Services>
            <Service>
              ...
              <div>
                ...
                <p>
                  ...
                  ties with other Phoenix influencers and aligned businesses, my
            ...
            <Service>
              ...
              <div>
                ...
                <p>
                  While local SEO anchors your pool company firmly in Phoenix,
                ...
                <p>
                  With our National SEO Service, let your Phoenix pool brand
        ...
        <div className="container">
          ...
          <Deliverables>
            ...
            <div>
              ...
              <p>
                Every strategy I craft aims at tangible growth for your Phoenix
                pool business.
              </p>
              <p>
          ...
          <Deliverables>
            ...
            <div className="grid-item-2">
              ...
              <p>
                ...
                you to make enlightened choices for your Phoenix pool business.
              </p>
              <p>
          ...
          <Deliverables>
            ...
            <div>
              ...
              <p>
                ...
                Phoenix, standing out is everything.
              </p>
              <p>
              ...
              <p>
                ...
                transform your pool enterprise into Phoenix's uncontested
                leader.
              </p>
              <p>
      ...
      <FAQ id="phoenixFaq">
        <div className="small-container">
          ...
          <div>
            <h3>
              How much does SEO consulting cost for pool companies in Phoenix?
            </h3>
            <p>
      ...
      <section className="hero">
        <div className="small-container">
          <h2 className="title">
            ...
            Leads and Sales for Your Phoenix Swimming Pool Company
          </h2>
          <img
